...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field children on 'UserProfile'
        m2m_table_name = db.shorten_name(u'core_userprofile_children')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field children on 'UserProfile'
        db.delete_table(db.shorten_name(u'core_userprofile_children'))
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'children': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'children_rel_+'", 'to': u"orm['core.UserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
