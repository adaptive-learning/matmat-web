...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Simulator.type'
        db.delete_column(u'questions_simulator', 'type')

        # Adding field 'Question.type'
        db.add_column(u'questions_question', 'type',
                      self.gf('django.db.models.fields.CharField')(default='t', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Simulator.type'
        db.add_column(u'questions_simulator', 'type',
                      self.gf('django.db.models.fields.CharField')(default='t', max_length=1),
                      keep_default=False)

        # Deleting field 'Question.type'
        db.delete_column(u'questions_question', 'type')
