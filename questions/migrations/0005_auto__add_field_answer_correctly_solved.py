...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.correctly_solved'
        db.add_column(u'questions_answer', 'correctly_solved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.correctly_solved'
        db.delete_column(u'questions_answer', 'correctly_solved')
