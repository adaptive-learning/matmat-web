...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for q in orm.Question.objects.filter(player=2):
            ...
            if "prefix" in data:
                data["with_text"] = True
                data["question"] = map(lambda x: int(x) if x.isdigit() else x, data["prefix"].split(" "))
                del data["prefix"]
            elif data["width"] <= 5:
                data["question"] = [data["question"][0] / data["width"], "&times;", data["width"]]
