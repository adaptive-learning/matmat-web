...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionDifficulty.time_intensity'
        db.add_column(u'model_questiondifficulty', 'time_intensity',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionDifficulty.time_intensity'
        db.delete_column(u'model_questiondifficulty', 'time_intensity')
    ...
    models = {
        ...
        u'model.questiondifficulty': {
            ...
            'time_intensity': ('django.db.models.fields.FloatField', [], {'default': '3.0'}),
