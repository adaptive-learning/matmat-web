...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'model_questiondifficulty', (
            ('question', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['questions.Question'], unique=True, primary_key=True)),
            ('value', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
    ...
    models = {
        ...
        u'model.questiondifficulty': {
            ...
            'question': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['questions.Question']", 'unique': 'True', 'primary_key': 'True'}),
