...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.children_list'
        db.add_column(u'model_skill', 'children_list',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.children_list'
        db.delete_column(u'model_skill', 'children_list')
