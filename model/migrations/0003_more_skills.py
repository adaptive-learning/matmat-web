...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        math = orm.Skill.objects.get(name='math')
        multiplication = orm.Skill(name='multiplication', parent=math, note=u'Násobení', level=2)
        multiplication.save()
        fractions = orm.Skill(name='fractions', parent=math, note=u'Dělení', level=2)
        fractions.save()
